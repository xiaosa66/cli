...
let init = async (templateName, projectName) => {
    console.log('init', templateName, projectName);
    if (!templateName || !projectName) {
        console.log(_logSymbols2.default.error, _chalk2.default.red('please input templateName and projectName like `yCli init simple simple`'));
        return;
    }
    //项目不存在
